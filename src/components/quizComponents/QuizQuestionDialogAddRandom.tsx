...
interface QuizQuestionDialogAddRandomProps {
  open: boolean;
  onClose: () => void;
  dialogTitle: string;
...
const QuizQuestionDialogAddRandom: React.FC<QuizQuestionDialogAddRandomProps> = ({
  open,
  onClose,
  dialogTitle,
  children,
...
export default QuizQuestionDialogAddRandom;
