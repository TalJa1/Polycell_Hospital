...
//
//CLASS_ACTION
export const FETCH_CLASS_BY_PROGRAMID = "FETCH_CLASS_BY_PROGRAMID";
//
// PROGRAM_ACTION_TYPE
...
export const FETCH_IMPORT_TRAINEES_SUCCESS = "FETCH_IMPORT_TRAINEES_SUCCESS";
